...
public class AltaFormulario extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
     ...
     logica.enviarDatos(modelo,marca,motor,color,placa,cantPuertas);
     
        //Mensaje de agregado
        mostrarMensaje("Auto agregado correctamente", "info", "Alta de Vehiculos");
        
        //Eliminamos los datos anteriores para poder agregar nuevos
        eliminarDatos();
